...
#   Step 1 (meowcat rctd):       deconvolution_rctd/major_prop.csv
#   Step 3 (meowcat preprocess): anno-names.txt, anno_matrix.tsv,
...
# Use --samples only to override (e.g. --samples VIS_P11_LUAD).
