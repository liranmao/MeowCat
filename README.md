...
2. Align the H&E image to the Xenium DAPI image using an external tool (e.g., HistoSweep). This produces a coordinate transformation from H&E pixel space to DAPI pixel space.
