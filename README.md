...
All other intermediate files (embeddings, batch `.npy` files, metadata, masks) are generated automatically by the pipeline. See `config/default.yaml` for output path configuration.
